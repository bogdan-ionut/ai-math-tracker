# Roadmap archive — completed sprints 0 to 5

Delivered work, preserved verbatim from the roadmap as it stood on 2026-07-25, before the
post-review revision. Kept so the record of what was planned and why is not lost when the
active roadmap is rewritten.

For what comes next see [IMPLEMENTATION_ROADMAP.md](IMPLEMENTATION_ROADMAP.md); for why it
changed see [REVIEW_RESPONSE.md](REVIEW_RESPONSE.md).
